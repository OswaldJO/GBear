...
object GBearStreamProtocols {
    const val VIDEO_MAGIC = 0x31564247 // GBV1
    const val AUDIO_MAGIC = 0x31414247 // GBA1
    const val AUDIO_SUBSCRIBE_MAGIC = 0x53414247 // GBAS
    const val INPUT_MAGIC = 0x31494247 // GBI1
    const val KEYBOARD_MAGIC = 0x314B4247 // GBK1
    const val GAMEPAD_MAGIC = 0x31474247 // GBG1
